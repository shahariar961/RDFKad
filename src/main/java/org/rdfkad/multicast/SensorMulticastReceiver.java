...
public class SensorMulticastReceiver implements Runnable {
    ...
    private static final int BOOTSTRAP_SERVER_PORT = 9091;
    ...
    public void handleTemperatureAlarm(int ownMulticastId, String dataAddress, int temperature) {
        ...
        if (!selfAlarmState) {
            if (alarmingNeighbors.isEmpty()) {
                ...
                if (consensusHandler.runConsensusAlgorithm(alarmingNeighbors)) {
                    ...
                    System.out.println("Consensus Success p1");
                ...
                if (consensusHandler.runConsensusAlgorithm(alarmingNeighbors)) {
                    ...
                    System.out.println("Consensus Success p2");
                    nodeConfig.setSelfAlarmState(true);
                    recordConsensusTimestampAndCalculateLatency(ownMulticastId);
                }
                ...
                if (consensusHandler.runConsensusAlgorithm(alarmingNeighbors)) {
                    ...
                    System.out.println("Consensus Success p3");
                    recordConsensusTimestampAndCalculateLatency(ownMulticastId);
                }
            }
                ...
                if (consensusHandler.runConsensusAlgorithm(alarmingNeighbors)) {
                    ...
                    System.out.println("Consensus Success p4");
                    recordConsensusTimestampAndCalculateLatency(ownMulticastId);
                }
            }
        } else {
    ...
    public void handleTemperatureBelowThreshold(int ownMulticastId, String dataAddress) {
